...
> Historical plan: alias selectors and shared 1:N/N:1/N:N scenarios below describe the v0.1.0 design. Candidate implementation documentation is preserved in the [MCP contract](../../90-Proposals/initial-vault-population/contracts/mcp-v2.md) and [interactive architecture](../../90-Proposals/initial-vault-population/architecture/interactive/index.html).
