...
- [`Product-Definition.md`](./Product-Definition.md) owns the approved product identity, agent problem, integrated product promise, extension-backed CDP relay model, managed-tab workspace model, capabilities, constraints, and success conditions.
