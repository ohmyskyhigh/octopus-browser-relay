...
> Vault status: preserved implementation documentation under the initial vault-population proposal; not yet promoted into canonical System authority.
...
9. Run `scripts/real-world-cleanup.ps1 -RunId <run-id>`. It preserves evidence and never removes user Chrome profiles.
