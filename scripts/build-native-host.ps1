...
$outputDirectory = Join-Path $workspace 'dist\apps\native-host'
...
$compileCommand = 'call "{0}" -arch=x64 && cl /nologo /EHsc /O2 /W4 /DUNICODE /D_UNICODE "{1}" /Fe:"{2}" /link winhttp.lib' -f $developerCommand, $source, $output
